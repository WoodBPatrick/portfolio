void setup() {
  ...
  println("\n\n");//search is method 12
  println(tree.search(100)?"The tree contains 100!":"The tree does not contain 100!");
  println(tree.search(114)?"The tree contains 114!":"The tree does not contain 114!");
  ...
  println();
  println(tree);//15
  println(tree.isFull()?"The tree is full":"The tree is not full");
}
